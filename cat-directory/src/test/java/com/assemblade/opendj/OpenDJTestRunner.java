...
public class OpenDJTestRunner extends BlockJUnit4ClassRunner {
	...
	public OpenDJTestRunner(Class<?> clazz) throws InitializationError {
		super(clazz);
	}
	...
	protected void runChild(FrameworkMethod method, RunNotifier notifier) {
		try {
            ...
            DirectoryServer.getEntryCache().clear();
		} catch (Exception e) {
