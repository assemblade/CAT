...
public class PropertyManagerTest extends AbstractUserManagementTest {
	...
	public void administratorCanAssignPermissionsToAFolder() throws Exception {
		...
		Folder folder = createFolder("folder1", false, Arrays.asList(group1.getDn()), Arrays.asList(group2.getDn()));
        ...
        assertEquals(group1.getDn(), folders.get(0).getReadGroups().get(0));
        assertEquals(1, folders.get(0).getWriteGroups().size());
        assertEquals(group2.getDn(), folders.get(0).getWriteGroups().get(0));
    }
    ...
    public void userWithReadPermissionsCanReadFolder() throws Exception{
        ...
        Folder folder = createFolder("folder1", false, Arrays.asList(group1.getDn()), null);
    ...
    public void usersFromDifferentGroupsWithReadPermissionsCanReadFolder() throws Exception {
        ...
        Folder folder = createFolder("folder1", false, Arrays.asList(group1.getDn(), group2.getDn()), null);
    ...
    public void userWithWritePermissionsCanAddFolder() throws Exception {
        ...
        Folder folder1 = test.addFolder(createFolder("folder1", false, null, Arrays.asList(group1.getDn(), group2.getDn())));
    ...
    public void userWithWritePermissionsDeleteFolder() throws Exception {
        ...
        Folder folder1 = createFolder("folder1", false, null, Arrays.asList(group1.getDn()));
    ...
    public void userCanCreateFolderWithoutInheritedPermissions() throws Exception {
        ...
        Folder folder1 = createFolder("folder1", false, null, Arrays.asList(group1.getDn(), group2.getDn()));
    ...
    public void userCanRenameAFolder() throws Exception {
        ...
        Folder folder = createFolder("folder1", false, null, Arrays.asList(group1.getDn()));
    ...
    public void userCanMoveAFolderToAnotherFolder() throws Exception {
        ...
        Folder folder1 = test.addFolder(createFolder("folder1", false, null, Arrays.asList(group1.getDn())));
        Folder folder2 = test.addFolder(createFolder("folder2", false, null, Arrays.asList(group1.getDn())));
    ...
    private Folder createFolder(String name, boolean inherit, List<String> readGroups, List<String> writeGroups) {
        Folder folder = new Folder();
        folder.setName(name);
    ...
    private Folder createFolder(String name, Folder parent, boolean inherit, List<String> readGroups, List<String> writeGroups) {
        Folder folder = new Folder();
        folder.setName(name);
        folder.setParentDn(parent.getDn());
        folder.setParentId(parent.getId());
